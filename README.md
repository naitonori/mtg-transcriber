...
- 初回利用時はモデルファイルのダウンロードが大きく、`kotoba-tech/kotoba-whisper-v2.0` は約700MB規模の通信が発生します。
...
- マイク録音と録音後の自動文字起こし
- 日本語 / 英語 / 自動判定の言語選択
- kotoba-whisper-v2.0 / whisper-small のモデル切替
...
- メイン: `kotoba-tech/kotoba-whisper-v2.0`
- フォールバック: `Xenova/whisper-small`
